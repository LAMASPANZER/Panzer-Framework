<?php
/* Smarty version 3.1.32, created on 2018-05-10 11:44:53
  from '/home/lamaspanzer/srv_apache/dev2.panzer.lan/App/Views/page.post.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5af414953ad326_16150914',
...
function content_5af414953ad326_16150914 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr" xmlns:og="http://ogp.me/ns#">
	<head>
		...
		<title>Quelques outils de monitoring indispensable à l'administration de votre debian</title>
		<meta name="description" content="La habilement simplement condamnait au frequentes gouverneur et claquaient. Ca sommes glisse le lasser douces canons aimons. Un ames noms tu arcs pris le. Faudrait par ils revendre posseder lumieres trahison ete. Je dentelles je je perruches culbutent. Metal quels hisse me oh. Activite par couleurs que galopent ici fut. ">
		<meta name="author" content="Guillaume GUERIN">

		<meta property="og:site_name" content="FromScratch">
		<meta property="og:title" content="Quelques outils de monitoring indispensable à l'administration de votre debian">
		<meta property="og:url" content="http://dev2.panzer.lan/article/outils-de-supervision">
		<meta property="og:description" content="La habilement simplement condamnait au frequentes gouverneur et claquaient. Ca sommes glisse le lasser douces canons aimons. Un ames noms tu arcs pris le. Faudrait par ils revendre posseder lumieres trahison ete. Je dentelles je je perruches culbutent. Metal quels hisse me oh. Activite par couleurs que galopent ici fut. ">
		<meta property="og:image" content="http://data.dev.panzer.lan/images/htop.png">
	...
	<body>
		...
		<div class="header-post" data-stellar-background-ratio="2" style="background-image: url('');">
			<div class="container">
				<div class="header-content">
					<h1>Quelques outils de monitoring indispensable à l'administration de votre debian</h1>
					<h4><span class="hidden-xs">Mis en ligne le </span><span class="visible-xs-inline"><i class="fa fa-calendar" aria-hidden="true"></i></span>  9 Avril 2017 </span></span> par</span><span class="visible-xs-inline"></span> Guillaume GUERIN <a href="#disqus_thread" data-disqus-identifier="outils-de-supervision"></a></h4>
		...
		<!--<div class="top-bar">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<span><span class="hidden-xs">Publié le</span><span class="visible-xs-inline"><i class="fa fa-calendar" aria-hidden="true"></i></span>  9 Avril 2017 </span></span>
			  ...
			  <div class="col-sm-12">
				...
				<script>
					var disqus_config = function () {
					  this.page.identifier = "outils-de-supervision";
					};
					(function() {
