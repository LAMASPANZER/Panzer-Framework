<?php
/* Smarty version 3.1.32, created on 2018-05-10 11:48:27
  from '/home/lamaspanzer/srv_apache/dev2.panzer.lan/App/Views/page.post.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5af4156b2511d9_15165887',
...
function content_5af4156b2511d9_15165887 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr" xmlns:og="http://ogp.me/ns#">
	<head>
		...
		<title>Serveur de fichiers avec samba sous Debian 8</title>
		<meta name="description" content="Un serveur de fichier sous linux est très simple à mettre en place !">
		<meta name="keywords" content="samb, serveur, de fichiers, linux, debian">
		<meta name="author" content="Guillaume GUERIN">

		<meta property="og:site_name" content="FromScratch">
		<meta property="og:title" content="Serveur de fichiers avec samba sous Debian 8">
		<meta property="og:url" content="http://dev2.panzer.lan/article/configuration-samba-debian">
		<meta property="og:description" content="Un serveur de fichier sous linux est très simple à mettre en place !">
		<meta property="og:image" content="http://data.dev.panzer.lan/images/samba.jpg">
	...
	<body>
		...
		<div class="header-post" data-stellar-background-ratio="2" style="background-image: url('');">
			<div class="container">
				<div class="header-content">
					<h1>Serveur de fichiers avec samba sous Debian 8</h1>
					<h4><span class="hidden-xs">Mis en ligne le </span><span class="visible-xs-inline"><i class="fa fa-calendar" aria-hidden="true"></i></span> 20 Mars 2017 <span class="hidden-xs">et mis à jour le  1 Avril 2017</span></span> par</span><span class="visible-xs-inline"></span> Guillaume GUERIN <a href="#disqus_thread" data-disqus-identifier="configuration-samba-debian"></a></h4>
		...
		<!--<div class="top-bar">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<span><span class="hidden-xs">Publié le</span><span class="visible-xs-inline"><i class="fa fa-calendar" aria-hidden="true"></i></span> 20 Mars 2017 <span class="hidden-xs">et mis à jour le  1 Avril 2017</span></span>
...
<h1>Configuration</h1>
<p>Par défault le système d'authentification est celui du système vous devrez donc configurés les utilisateurs pour samba</p>
<pre><code class="lang-bash">add user tux
smbpasswd -a tux</code></pre>
<p>Par défault un répertoire à son nom sera créé dans le &quot;/home/tux&quot; on n'y mettra donc les dossiers partagés:</p>
<pre><code class="lang-bash">su tux
cd ~ &amp;&amp; mkdir movies musics data</code></pre>
<p>La configuration de samba se trouve dans &quot;/etc/samba/smb.conf&quot;:</p>
<pre><code class="lang-bash">vim /etc/samba/smb.conf</code></pre>
<pre><code class="lang-bash">[global]
server string = debian #Nom du serveur (hostname)
workgroup = WORKGROUP
netbios name = Maison # Le nom visible sur le réseau
public = yes
encrypt passwords = true

#Cette partie concerne les répertoires partagés
[Vidéos] # Le nom du répertoire partagé
path = /home/tux/movies #Chemin
read only = no
writeable = yes
valid users =  tux # Utilisateur(s) y en accès (séparé par une virgule)
comment = Mes Vidéos

[Musiques]
path = /home/tux/musics
read only = no
writeable = yes
valid users =  tux
...
writeable = yes
valid users =  tux
comment = Mes Documents</code></pre>
<p>Rédemarrer le service</p>
<blockquote>
<p>service smbd restart</p>
</blockquote>
<p><img src="http://data.fromscratch.ovh/images/samba_final.png" alt="enter image description here" data-lightbox="" /></p>
					</div>
			  ...
			  <div class="col-sm-12">
				...
				<script>
					var disqus_config = function () {
					  this.page.identifier = "configuration-samba-debian";
					};
					(function() {
